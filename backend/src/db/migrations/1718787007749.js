module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('quizzes', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('questions', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('payments', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('images', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('answers', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('quizzes', 'title', { transaction });

      await queryInterface.removeColumn('questions', 'quizId', { transaction });

      await queryInterface.removeColumn('questions', 'question_text', {
        transaction,
      });

      await queryInterface.removeColumn('payments', 'userId', { transaction });

      await queryInterface.removeColumn('payments', 'date', { transaction });

      await queryInterface.removeColumn('payments', 'amount', { transaction });

      await queryInterface.removeColumn('payments', 'gateway', { transaction });

      await queryInterface.removeColumn('images', 'uploaded_byId', {
        transaction,
      });

      await queryInterface.removeColumn('images', 'title', { transaction });

      await queryInterface.removeColumn('answers', 'questionId', {
        transaction,
      });

      await queryInterface.removeColumn('answers', 'is_correct', {
        transaction,
      });

      await queryInterface.removeColumn('answers', 'answer_text', {
        transaction,
      });
