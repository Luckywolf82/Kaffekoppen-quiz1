...
module.exports = function (sequelize, DataTypes) {
  ...
  organizations.associate = (db) => {
    ...
    db.organizations.hasMany(db.answers, {
    ...
    db.organizations.hasMany(db.images, {
      as: 'images_organization',
      foreignKey: {
        name: 'organizationId',
      },
      constraints: false,
    ...
    db.organizations.hasMany(db.questions, {
