    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Images UploadedBy</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.images_uploaded_by &&
                      Array.isArray(users.images_uploaded_by) &&
                      users.images_uploaded_by.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!users?.images_uploaded_by?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Payments User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.payments_user &&
                      Array.isArray(users.payments_user) &&
                      users.payments_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
