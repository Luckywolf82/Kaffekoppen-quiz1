      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{questions?.quiz?.title ?? 'No data'}</p>
          </div>
          ...
          <>
            <p className={'block font-bold mb-2'}>Answers Question</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
                ...
                <table>
                  ...
                  <tbody>
                    {questions.answers_question &&
                      Array.isArray(questions.answers_question) &&
                      questions.answers_question.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(`/answers/answers-view/?id=${item.id}`)
              ...
              {!questions?.answers_question?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
