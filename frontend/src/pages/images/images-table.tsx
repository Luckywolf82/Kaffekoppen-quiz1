...
import TableImages from '../../components/Images/TableImages';
...
import { setRefetch, uploadCsv } from '../../stores/images/imagesSlice';

import { hasPermission } from '../../helpers/userPermissions';

const ImagesTablesPage = () => {
  ...
  return (
    <>
      <Head>
        <title>{getPageTitle('Images')}</title>
      </Head>
      <SectionMain>
...
export default ImagesTablesPage;
