...
const PaymentsTablesPage = () => {
  ...
  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_PAYMENTS');
  ...
  const getPaymentsCSV = async () => {
    const response = await axios({
      url: '/payments?filetype=csv',
      method: 'GET',
      responseType: 'blob',
    });
...
export default PaymentsTablesPage;
