...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/images/imagesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureImagesCols';
...
const TableSampleImages = ({
  ...
  useEffect(() => {
    if (imagesNotify.showNotification) {
      notify(imagesNotify.typeNotification, imagesNotify.textNotification);
    }
  }, [imagesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/images/images-view/?id=${id}`);
  };
...
export default TableSampleImages;
