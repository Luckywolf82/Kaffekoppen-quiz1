...
const ListAnswers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_ANSWERS');
              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>AnswerText</p>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter.questionsOneListFormatter(item.question)}
                    </p>
                  </div>
                </div>
                <ListActionsPopover
